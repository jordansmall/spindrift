...
| `CODE_FORGE_ACCUMULATION_REPO_DIR` | — (required when `CODE_FORGE=local`) | host path to the bare Accumulation repo, mounted read-only into the Box and landed into host-side |
