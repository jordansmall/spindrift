...
| [`docs/flake-options.md`](docs/flake-options.md) | Schema-generated reference for every flake option, grouped by domain (ADR 0037) — attr path, env var, default, description; regenerated by `nix flake check` |
