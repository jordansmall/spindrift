...
**`CODE_FORGE=forgejo`** (Forgejo/Gitea Code Forge — the Box opens the PR
directly against the Forgejo API and the launcher watches CI and merges it
host-side, ADR 0038 + issue #1961): continue with OPEN A PULL REQUEST below.
