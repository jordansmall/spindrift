...
REVIEW's triage has three outcomes, and two of them are already settled
by the time the filer runs: what was cheap and in scope was fixed inline,
and what was trivial and out of scope was dropped without filing. Escalation
is the third, and it is this step. Delegate to the filer subagent only the
...
plus, from the second review round on, an ambiguous finding REVIEW's own
round-aware tiebreak deferred rather than fixed. If none survived, skip
this step; do not re-file what you just fixed or dropped.
