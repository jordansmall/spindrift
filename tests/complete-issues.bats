#!/usr/bin/env bats
# __complete-issues (issue #556) is the hidden command the bash/zsh/fish
# completion renderers shell out to for issue-number completion on
# dispatch/preview/recover. These tests run the real spindrift binary against
# the tests/fakes/gh tracker fake, so none of them touch the network.
