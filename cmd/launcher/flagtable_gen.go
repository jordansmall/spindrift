...
var schemaFlags = []flagEntry{
	...
	{env: "ISSUE_TRACKER", flag: "issue-tracker", group: "Issue discovery", kind: "string", doc: "IssueTracker backend: github (gh-exec) or local (private Markdown + YAML frontmatter files; see LOCAL_ISSUES_DIR)", dflt: "github"},
