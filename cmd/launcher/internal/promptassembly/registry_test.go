...
// transcription of every row in lib/fragments.nix (61 rows as of issue
// #2349) — and spot-checks a handful of known rows rather than asserting the
// full 61-row payload verbatim, so this test doesn't itself become the thing
